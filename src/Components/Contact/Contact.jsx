...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "eae082e1-744d-4a36-936e-4cb16107121d");
...
<ul>
    <li><img src={mail_icon} alt=""/>aishwaryaretawade14@gmail.com</li>
    <li><img src={phone_icon} alt=""/>+91 8373737389</li>
    
    <li><img src={location_icon} alt=""/>Mumbai,Maharashtra</li>
...
<form onSubmit={onSubmit}>
    ...
    <input type="tel" name="phone" placeholder="Enter your numbaer" required/>
